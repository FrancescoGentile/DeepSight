...
class BatchedBoundingBoxes:
    ...
    def area(self) -> Annotated[Tensor, "B N", float]:
    ...
    def aspect_ratio(self) -> Annotated[Tensor, "B N", float]:
    ...
    def union_area(self, other: Self) -> Annotated[Tensor, "B N", float]:
    ...
    def intersection_area(self, other: Self) -> Annotated[Tensor, "B N", float]:
    ...
    def iou(self, other: Self) -> Annotated[Tensor, "B N", float]:
