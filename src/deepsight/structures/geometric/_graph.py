...
from deepsight.typing import Moveable, Number, SparseTensor, Tensor
...
class Graph(Moveable):
    ...
    def __init__(
        self,
        adjacency_matrix: Tensor[Literal["N N"], Number]
        | SparseTensor[Literal["N N"], Number],
        node_features: Tensor[Literal["N D"], Number],
        edge_features: Tensor[Literal["E C"], Number] | None = None,
    ...
    ) -> SparseTensor[Literal["B N N"], Number]: ...

    @overload
    def adjacency_matrix(
        self, batch_mode: Literal[BatchMode.SEQUENCE]
    ) -> tuple[SparseTensor[Literal["N N"], Number], ...]: ...
    ...
    def edge_features(
        self, batch_mode: Literal[BatchMode.CONCAT] = BatchMode.CONCAT
    ) -> Tensor[Literal["E C"], Number] | None: ...

    @overload
    def edge_features(
        self, batch_mode: Literal[BatchMode.STACK]
    ) -> Tensor[Literal["B E C"], Number] | None: ...

    @overload
    def edge_features(
        self, batch_mode: Literal[BatchMode.SEQUENCE]
    ) -> tuple[Tensor[Literal["E C"], Number], ...] | None: ...

    def edge_features(
        self, batch_mode: BatchMode = BatchMode.CONCAT
    ) -> (
        Tensor[Literal["E C"], Number]
        | Tensor[Literal["B E C"], Number]
        | tuple[Tensor[Literal["E C"], Number], ...]
        | None
    ):
    ...
    def replace(  # noqa
        ...
        | None = None,
        edge_features: Tensor[Literal["E C"], Number]
        | Tensor[Literal["B E C"], Number]
        | Iterable[Tensor[Literal["E C"], Number]]
        | None = None,
    ) -> Self:
        ...
        elif isinstance(edge_features, torch.Tensor):
